...
import {courseJoyData} from "../datapoints.js"
...
export default function LineChart ({num}) {
    ...
    const filterData = courseJoyData.filter(item => {
                        ...
                        tooltip: {
                            callbacks: {
                                ...
                                label: function (context) {  
                                    return  `Day: ${context.raw.x}, Avg: ${context.raw.y}, Count: ${context.raw.count}`
                                },
                            }
                        }
                    },
